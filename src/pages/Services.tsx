...
const Services = () => {
  ...
  const handleConfirmPurchase = async () => {
    ...
    const walletBalanceNumber = parseFloat(walletBalance.toFixed(2));
const totalCostRounded = parseFloat(totalCost.toFixed(2));

    if (walletBalanceNumber < totalCostRounded) {
      toast({
